# Generated by Django 3.2.8 on 2023-12-28 15:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.FileField(blank=True, upload_to='', verbose_name='Главное фото')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='svoy01.chat')),
            ],
        ),
    ]
